...
import 'package:flash_chat/Modules/todo/home_page.dart';
import 'package:flutter/material.dart';
...
class HomePage extends StatelessWidget {
      ...
      child: Column(
        ...
        children: <Widget>[
          Padding(
            ...
            child: _buildHelloWidget(context: context, name: 'JAY'),
          ),
          SizedBox(height: 5.0),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 20.0),
  ...
  Widget _buildTaskTypesWidget({@required BuildContext context}) {
    return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <
        Widget>[
      _buildTaskStatusWidget(context: context, count: '3', title: 'Created'),
      _buildTaskStatusWidget(context: context, count: '0', title: 'Completed'),
    ]);
  }
